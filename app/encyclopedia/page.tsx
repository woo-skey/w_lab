...
const WHISKEYS: Record<Exclude<Category, "전체">, WhiskeyEntry[]> = {
  스카치: [
    {
      id: "glenlivet-12",
    ...
    },
    {
      ...
      abv: 40,
      nose: "건포도, 무화과, 진저",
      palate: "풍부한 셰리, 초콜릿, 오렌지 껍질",
      finish: "길고 따뜻한 스파이시 여운",
      description: "셰리 오크 캐스크의 정수. 달콤하고 과일향 풍부한 스피사이드 대표작.",
      priceRange: "₩90,000–120,000",
      difficulty: "입문",
      tags: ["싱글몰트", "Speyside", "셰리캐스크", "초콜릿"],
    },
    {
      id: "lagavulin-16",
      name: "Lagavulin 16",
      ...
      age: 16,
      abv: 43,
      nose: "강렬한 피트, 바다소금, 스모키",
      palate: "두꺼운 피트, 스위트몰트, 아이오딘",
      finish: "매우 길고 드라이한 스모키 여운",
      description: "아일라 피트 위스키의 교과서. 강렬하고 복잡한 스모키 풍미의 정점.",
      priceRange: "₩100,000–140,000",
      difficulty: "상급",
      tags: ["싱글몰트", "Islay", "피트", "스모키", "강렬함"],
    },
    {
      id: "laphroaig-10",
      name: "Laphroaig 10",
  ...
  "버번/라이": [
    ...
    },
    {
      ...
      abv: 45,
      nose: "달콤한 맥아, 바닐라, 꿀",
      palate: "카라멜, 버터, 부드러운 스파이스",
      finish: "달콤하고 따뜻한 여운",
      description: "밀 매시빌로 만든 부드러운 버번. 빨간 왁스 인장으로 유명한 아이콘.",
      priceRange: "₩45,000–60,000",
      difficulty: "입문",
      tags: ["버번", "Kentucky", "부드러움", "밀매시빌"],
    },
    {
      id: "woodford-reserve",
    ...
    },
    {
      ...
      abv: 50.5,
      nose: "카라멜, 바닐라, 오크",
      palate: "진한 캐러멜, 스파이스, 오렌지",
      finish: "강렬하고 긴 스파이시 여운",
      description: "101 프루프의 강렬한 버번. 오크통 풍미가 진하고 개성 넘치는 하이프루프 스탠다드.",
      priceRange: "₩40,000–55,000",
      difficulty: "중급",
      tags: ["버번", "Kentucky", "하이프루프", "강렬함"],
    },
    {
      id: "rittenhouse-rye",
      ...
      abv: 50,
      nose: "호밀빵, 민트, 스파이스",
      palate: "진한 스파이스, 후추, 달콤함",
      finish: "드라이하고 긴 스파이시 여운",
      description: "가성비 최고의 라이 위스키. 칵테일 베이스로도, 스트레이트로도 탁월.",
      priceRange: "₩35,000–50,000",
      difficulty: "중급",
      tags: ["라이", "Pennsylvania", "스파이시", "칵테일"],
    },
    {
      id: "bulleit-bourbon",
      ...
      abv: 45,
      nose: "오크, 메이플시럽, 향신료",
      palate: "매운 호밀향, 바닐라, 오렌지껍질",
      finish: "드라이하고 길게 지속되는 스파이시",
      description: "높은 라이 함량으로 스파이시한 개성. 심플한 병 디자인과 탄탄한 맛.",
      priceRange: "₩40,000–55,000",
      difficulty: "입문",
      tags: ["버번", "Kentucky", "하이라이", "스파이시"],
    },
  ],
  기타: [
    {
...
export default function EncyclopediaPage() {
  ...
  const allWhiskeys = Object.values(WHISKEYS).flat();
  const baseList = selectedCategory === "전체" ? allWhiskeys : WHISKEYS[selectedCategory] ?? [];
  const filtered = baseList.filter((w) =>
    !searchQuery.trim() ||
    w.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
    w.distillery.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-12">
        {/* 헤더 */}
        <h1 className="text-4xl font-bold text-white mb-2">위스키 백과</h1>
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={label} className="flex gap-2 text-sm">
                            <span className="text-indigo-400/70 font-medium w-12 flex-shrink-0">
